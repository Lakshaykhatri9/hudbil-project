  ...
  return (
    <>
      <div className="bg-[#3e3e3e]">
        {" "}
        <Navbar
          navbgcolor="bg-[#3e3e3e]"
          onMenuOpen={handleMenuOpen}
          textColorLiHover="text-[#FE7272]"
        />
      </div>
      <div className=" -mt-1 bg-[#3e3e3e] flex flex-col items-center justify-center h-[85vh] relative">
        <div className="flex flex-col justify-center items-center absolute top-0 md:relative lg:absolute lg:top-0 xl:absolute xl:top-0 2xl:relative">
          <svg
            width="300"
            height="413"
            viewBox="0 0 669 413"
            ...
            className="pb-32 md:pb-0 lg:pb-32 xl:pb-48 md:w-[600px] md:[713px] lg:w-[300px] lg:h-[413px] xl:w-[300px] xl:h-[413px] 2xl:w-[650px] 2xl:h-[773px] "
            // 2xl:w-[800px] 2xl:h-[913px]
          >
          ...
          <h3
            className="font-[700] text-3xl md:text-5xl lg:text-3xl xl:text-4xl 2xl:text-[90px] absolute bottom-28 md:-bottom-10 lg:bottom-28 xl:bottom-36 "
            // 2xl:text-[90px]
          >
            DEVELOPMENT
          </h3>
        ...
        <div
          className={`${
            menuOpen
              ? "hidden"
              : "absolute bottom-10 lg:bottom-20 xl:bottom-20 2xl:bottom-14 "
          }`}
        >
          <marquee scrollamount="10">
            <h1 className="text-4xl md:text-6xl lg:text-4xl xl:text-6xl 2xl:text-8xl font-thin">
              {/* 2xl:text-8xl  */}
              You have 3-5 seconds to capture their attention. They’re not your
              mum.
            </h1>
          </marquee>
        </div>
      ...
      <div className="bg-[#3e3e3e] p-3 lg:p-[100px] -mt-1">
        <div>
          <p className="lg:my-10 font-[400] md:text-2xl text-sm 2xl:w-9/12 2xl:text-[32px] 2xl:leading-[48px]">
          ...
          <p className="lg:my-10 my-8 font-[400] md:text-2xl text-sm  2xl:w-9/12 2xl:text-[32px] 2xl:leading-[48px]">
      ...
      <div className="bg-[#3e3e3e] p-3 -mt-1">
        <div className="carousel ">
          ...
          <div className="gap-3 mt-auto mr-5 pb-10 flex flex-row-reverse">
            <button
              className="next my-3 text-white  sm:w-[48px] sm:h-[24px] w-[12vmin] rounded-full"
            ...
            >
              ...
              >
                ...
                />
                <g
                  clipPath="url(#clip0_4855_154)"
                  className="right-arrow-animation"
                >
                  <g clipPath="url(#clip1_4855_154)">
                    <path
            ...
            <button
              className="prev my-3 text-white sm:w-[48px] sm:h-[24px] w-[12vmin] rounded-full"
            ...
            >
              ...
              >
                ...
                />
                <g
                  clipPath="url(#clip0_4855_148)"
                  className="left-arrow-animation"
                >
                  <g clipPath="url(#clip1_4855_148)">
                    <path
      ...
      <div className="bg-[#3e3e3e] p-3 lg:p-[100px] lg:-mt-20 -mt-1">
        <div>
          <p className="lg:my-10 font-[400] md:text-2xl text-sm  2xl:w-9/122xl:text-[32px] 2xl:leading-[48px]">
          ...
          <p className="lg:my-10 2xl:mt-14 mt-4 font-[400] md:text-2xl text-sm 2xl:w-10/12  2xl:text-[32px] 2xl:leading-[48px]">
          ...
          <p className="lg:my-10 2xl:mt-14 mt-4 font-[400] md:text-2xl text-sm  2xl:w-9/12 2xl:text-[32px] 2xl:leading-[48px]">
            We do web development without compromise. we love building
            beautiful, creative websites that effectively drive real results for
            your business.
          </p>
          <p className="lg:my-10 2xl:my-14 mt-4 font-[400] md:text-2xl text-sm 2xl:w-10/12  2xl:text-[32px] 2xl:leading-[48px]">
            We have always believed that websites can and must be both beautiful
            and functional - and not just one or the other. In everything we do,
            we pay meticulous attention to detail, ensuring that we can take
            pride in everything we put out into the world.
              ...
              <div className="md:flex justify-between my-5 ">
                <div className="lg:w-[50vw]">
                  <div className="mt-5 flex justify-between items-center">
                    <div>
                      {" "}
                      <button className="border border-white rounded-full w-[210px] h-[40px] text-[20px] font-[100] bg-[#596e5c]">
                        OUR APPROACH
                      </button>
                      <h1 className="text-[10vmin] sm:text-[70px] lg:text-[96px] font-[300] mt-4 lg:mt-">
                        WE THINK BIG.
                      </h1>
                    </div>
                  ...
                  <div className="mt-10">
                    {" "}
                    <p className="lg:text-[24px] 2xl:leading-[36px] text-[4vmin] font-[300]">
                      {slide.description}{" "}
                    </p>
                  </div>
                ...
                <div className="hidden lg:block">
                  ...
                  <img
                    ...
                    alt="Brand Photo"
                    className="w-[60vmin] 2xl:h-[730px]"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="lg:mt-16 md:mt-24 mt-10 md:flex lg:flex-row flex-col justify-between items-center ">
          <p className="font-[400] text-xl sm:text-2xl md:text-4xl lg:text-[48px] lg:leading-[65px] lg:w-8/12 w-full ">
        ...
        <div className="text-center mt-14 md:mt-28 md:space-y-5 2xl:space-y-8 ">
          {/* space-y-8 */}
        ...
        <div className="mt-10 sm:mt-28 gap-5 grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 md:border-t-[1px] ">
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                <button className="mt-8 md:mt-12 block rounded-full bg-[#596e5c] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 text-[13px] ">
                  Product Discovery
                </button>
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                ...
                <button className="mt-8 sm:mt-10 lg:mt-24 block rounded-full bg-[#596e5c] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 text-[13px]">
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-36 mt-10 block rounded-full bg-[#596e5c] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 lg:h-10 text-[13px]">
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-48 mt-10 block rounded-full bg-[#596e5c] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 md:h-10 text-[13px]">
          ...
          <div className="text-center">
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-60 mt-10 block rounded-full bg-[#596e5c] w-56 sm:w-60 lg:w-[15vw] h-8 text-[13px]">
                  Product Roadmap
                </button>
        ...
        <div className="mt-10 flex justify-center">
          <img src="/OtherPages/Developementimg/bussiness.svg" alt="" />
        </div>
        ...
        <div className="sm:my-20 my-10">
          <details className="pl-5 p-1 bg-[#596e5c] rounded-xl lg:rounded-2xl my-3">
        ...
        <div className="my-20 md:my-40">
          <div className="lg:text-[70px] lg:font-[600] text-2xl sm:text-3xl md:text-4xl">
            <Link to="/research">Next Service</Link>
