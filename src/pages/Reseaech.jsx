...
function Reseaech() {
  ...
  return (
    <>
      <div className="bg-[#007AAC] ">
        {" "}
        <Navbar
          navbgcolor="bg-[#007AAC]"
          onMenuOpen={handleMenuOpen}
          textColorLiHover="text-[#FE7272]"
        />
      </div>

      <div className=" -mt-1 bg-[#007AAC]  flex flex-col items-center justify-center h-[85vh] relative">
        ...
        <div className={`${menuOpen ? "hidden" : "absolute bottom-0 "}`}>
          <marquee scrollamount="10">
            <h1 className="lg:text-[50px] 2xl:text-[90px]  text-[9vmin] font-[200] sm:text-[11vmin] my-10">
              We dive deep into understanding your unique business challenges
      ...
      <div className="bg-[#007AAC]  -mt-1 p-3 md:p-[100px]">
        <div>
      ...
      <div className="bg-[#007AAC] p-3  -mt-1">
      ...
      <div className="bg-[#007AAC] p-3 md:p-[100px] lg:-mt-20  -mt-1">
        <div>
          <p className="font-[400] md:text-2xl text-sm">
          ...
          <p className="lg:my-10 my-10 font-[400] md:text-2xl text-sm">
          ...
          <p className="lg:my-10 font-[400] md:text-2xl text-sm">
            We have always believed that websites can and must be both beautiful
            and functional - and not just one or the other. In everything we do,
            we pay meticulous attention to detail, ensuring that we can take
            pride in everything we put out into the world.
              ...
              <div className="md:flex justify-between my-5 ">
                <div className="lg:w-[50vw]">
                  <div className="mt-5 flex justify-between items-center">
                    <div>
                      {" "}
                      <button className="border border-white rounded-full w-[210px] h-[40px] text-[20px] font-[100] bg-[#FF7400]">
                        OUR APPROACH
                      </button>
        ...
        <div className="mt-10 sm:mt-28 gap-5 grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 border-t-[1px] ">
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                <button className="mt-8 md:mt-12 block rounded-full bg-[#FF7400] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 text-[13px] ">
                  Product Discovery
                </button>
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                ...
                <button className="mt-8 sm:mt-10 lg:mt-24 block rounded-full bg-[#FF7400] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 text-[13px]">
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            ...
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-36 mt-10 block rounded-full bg-[#FF7400] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 lg:h-10 text-[13px]">
          ...
          <div className="text-center md:border-r border-gray-300 sm:h-[36vh]">
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-48 mt-10 block rounded-full bg-[#FF7400] w-56 md:w-48 sm:w-60 lg:w-[15vw] h-8 md:h-10 text-[13px]">
          ...
          <div className="text-center">
            <div className="flex justify-center">
              <div>
                ...
                <button className="lg:mt-60 mt-10 block rounded-full bg-[#FF7400] w-56 sm:w-60 lg:w-[15vw] h-8 text-[13px]">
                  Product Roadmap
                </button>
        ...
        <div className="mt-10 flex justify-center">
          <img src="/OtherPages/Researchimg/bussiness.svg" alt="" />
        </div>
        ...
        <div className="sm:my-20 my-10">
          <details className="pl-5 p-1 bg-[#FF7400] rounded-xl lg:rounded-2xl my-3"
          >
        ...
        <div className="my-20 md:my-40">
          <div className="lg:text-[70px] lg:font-[600] text-2xl sm:text-3xl md:text-4xl">
            <Link to="/strategy">Next Service</Link>
